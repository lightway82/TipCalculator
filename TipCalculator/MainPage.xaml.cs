    ...
    public partial class MainPage : ContentPage
    {
        public MainPage()
        {
            ...
            roundUp.Clicked += (s, e) => CalculateTip(true, false);
                ...
                ///tipPercentSlider.ValueChanged += OnTipPercentSliderOnValueChanged;
        }

        private void OnTipPercentSliderOnValueChanged(object s, ValueChangedEventArgs e)
        {
        ...
        {
            if (e.Value) SetDatkTheme();
            else SetLightTheme();
        }

        private void SetLightTheme()
        {
            Resources["bgColor"] = "White";
            Resources["fgColor"] = "#262626";
            Resources["btnBgColor"] = "Gray";
        }

        private void SetDatkTheme()
        {
            Resources["bgColor"] = "#262626";
            Resources["fgColor"] = "White";
            Resources["btnBgColor"] = "Black";
        }
    }
}
